...
public class CharacterTemplate
{
    ...
    protected int baseStat = 10;
    protected float baseSpeed = 10;

    public virtual void Move(Vector3 positionOrDirection, float speed)
    {
        //Debug.Log("Move");
    }
   ...
   /* public void LookAt(Vector3 whereToLook)
    {
        float speed = 7.5f;
    ...
    public void MoveToPosition(Vector3 positionToMoveTo, float speed)
    {
